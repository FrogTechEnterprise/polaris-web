(function () {
  ...
  var DICT = {
    es: {
      ...
      'testimonials.title': '¿Como puede ayudarte Polaris?',
      'testimonials.subtitle': 'Nos adaptamos a tu rubro: cafeteria, barberia, sastreria y mucho mas.',
      'testimonials.outro': 'No importa el sector: convertimos ideas en un plan claro y ejecutable.',
      'testimonials.1.title': '¿Me puede ayudar Polaris en mi cafetería?',
      'testimonials.1.answer': 'Por supuesto. Definimos propuesta, ticket medio, promociones y calendario comercial para que dejes de improvisar y crezcas con orden.',
      'testimonials.1.lang': 'Español',
      'testimonials.2.title': '¿Me puede ayudar Polaris en mi barbería?',
      'testimonials.2.answer': 'Sí, totalmente. Diseñamos metas semanales, agenda rentable y campañas simples para mejorar ocupación sin depender de descuentos constantes.',
      'testimonials.2.lang': 'Español',
      'testimonials.3.title': '¿Me puede ayudar Polaris en mi sastrería?',
      'testimonials.3.answer': 'Sin duda. Refinamos posicionamiento, mensaje y experiencia de compra para que el valor de tu trabajo se traduzca en más pedidos.',
      'testimonials.3.lang': 'Español',
      'testimonials.4.title': '¿Me puede ayudar Polaris en mi clínica dental?',
      'testimonials.4.answer': 'Desde luego. Alineamos captación, agenda y conversión para que tomes decisiones con datos y mejores la rentabilidad de cada servicio.',
    ...
    en: {
      ...
      'testimonials.1.title': 'Can Polaris help my coffee shop?',
      'testimonials.1.answer': 'Absolutely. We define offer, average ticket, promotions and a clear commercial calendar so you can grow with consistency.',
      'testimonials.1.lang': 'English',
      'testimonials.2.title': 'Can Polaris help my barbershop?',
      'testimonials.2.answer': 'Absolutely. We set weekly goals, improve schedule profitability and launch simple campaigns to keep chairs full.',
      'testimonials.2.lang': 'English',
      'testimonials.3.title': 'Can Polaris help my tailoring business?',
      'testimonials.3.answer': 'Absolutely. We sharpen your positioning, messaging and purchase experience so your craftsmanship converts into more orders.',
      'testimonials.3.lang': 'English',
      'testimonials.4.title': 'Can Polaris help my dental clinic?',
      'testimonials.4.answer': 'Absolutely. We align acquisition, booking and conversion so each service line performs with measurable profitability.',
    ...
    pt: {
      ...
      'testimonials.1.title': 'A Polaris pode ajudar a minha cafetaria?',
      'testimonials.1.answer': 'Claro. Definimos oferta, ticket medio, promocoes e calendario comercial para crescer com consistencia.',
      'testimonials.1.lang': 'Português',
      'testimonials.2.title': 'A Polaris pode ajudar a minha barbearia?',
      'testimonials.2.answer': 'Claro. Criamos metas semanais, agenda rentavel e campanhas simples para melhorar ocupacao.',
      'testimonials.2.lang': 'Português',
      'testimonials.3.title': 'A Polaris pode ajudar a minha alfaiataria?',
      'testimonials.3.answer': 'Claro. Melhoramos posicionamento, mensagem e experiencia de compra para gerar mais pedidos.',
      'testimonials.3.lang': 'Português',
      'testimonials.4.title': 'A Polaris pode ajudar a minha clinica dentaria?',
      'testimonials.4.answer': 'Claro. Alinhamos captacao, agenda e conversao para melhorar a rentabilidade de cada servico.',
    ...
    fr: {
      ...
      'testimonials.1.title': 'Polaris peut-il aider mon cafe?',
      'testimonials.1.answer': "Bien sur. Nous clarifions offre, ticket moyen, promotions et calendrier commercial pour une croissance reguliere.",
      'testimonials.1.lang': 'Français',
      'testimonials.2.title': 'Polaris peut-il aider mon salon de coiffure?',
      'testimonials.2.answer': "Bien sur. Nous definissons objectifs hebdomadaires, agenda rentable et campagnes simples pour mieux remplir les creneaux.",
      'testimonials.2.lang': 'Français',
      'testimonials.3.title': 'Polaris peut-il aider ma maison de couture?',
      'testimonials.3.answer': "Bien sur. Nous renforcons positionnement, message et parcours d'achat pour obtenir plus de commandes.",
      'testimonials.3.lang': 'Français',
      'testimonials.4.title': 'Polaris peut-il aider ma clinique dentaire?',
      'testimonials.4.answer': 'Bien sur. Nous alignons acquisition, prise de rendez-vous et conversion avec un pilotage par donnees.',
