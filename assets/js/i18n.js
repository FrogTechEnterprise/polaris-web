(function () {
  ...
  var DICT = {
    es: {
      ...
      'hero.title': '<span>Te ayudamos a vender más</span><span>con una estrategia clara y accionable.</span>',
      ...
      'que.card4.title': 'Analítica y decisiones',
      'que.card4.lead': 'Convertimos datos dispersos en señales claras para decidir con rapidez y menos riesgo.',
      'que.card4.focus': 'Trabajamos en: cuadro de mando, métricas clave y lectura práctica de resultados.',
      'que.card5.title': 'Acompañamiento ejecutivo',
      'que.card5.lead': 'Alineamos equipo, prioridades y ritmo de ejecución para que la estrategia avance de verdad.',
      'que.card5.focus': 'Trabajamos en: seguimiento, foco semanal y desbloqueo de decisiones.',
      ...
      'testimonials.subtitle': 'Resultados reales en distintos sectores y contextos.',
      'testimonials.outro': 'Historias reales, decisiones claras y crecimiento con foco.',
      'testimonials.1.quote': '"En tres meses pasamos de improvisar campañas a tener un plan comercial claro. El equipo entiende prioridades y las ventas crecieron de forma sostenida."',
      'testimonials.1.name': 'Laura Mendez',
      'testimonials.1.role': 'Directora comercial · Retail',
      'testimonials.1.lang': 'Español',
      'testimonials.2.quote': '"Pasamos de discutir ideas sueltas a ejecutar con orden. Hoy cada accion tiene responsable, fecha y un objetivo medible."',
      'testimonials.2.name': 'Adrian Rojas',
      'testimonials.2.role': 'Socio fundador · Alimentacion',
      'testimonials.2.lang': 'Español',
      'testimonials.3.quote': '"Con Polaris mejoramos el mensaje de marca y la captacion. En dos trimestres aumentamos los leads cualificados sin inflar presupuesto."',
      'testimonials.3.name': 'Claudia Paredes',
      'testimonials.3.role': 'Responsable de marketing · Textil',
      'testimonials.3.lang': 'Español',
      'testimonials.4.quote': '"Nos ayudaron a simplificar la operacion digital y a tomar decisiones mas rapidas con datos claros. El equipo trabaja con menos friccion."',
      'testimonials.4.name': 'Nicolas Gomez',
      'testimonials.4.role': 'CEO · Decoracion',
      'testimonials.4.lang': 'Español',
      'testimonials.5.quote': '"La hoja de ruta de 90 dias fue clave para recuperar foco. Dejamos de reaccionar y empezamos a construir crecimiento sostenido."',
      'testimonials.5.name': 'Sofia Vega',
      'testimonials.5.role': 'Direccion general · Restauracion',
      'testimonials.5.lang': 'Español',
      'testimonials.6.quote': '"Lo mejor fue la implementacion: reuniones utiles, decisiones concretas y seguimiento real. Vimos impacto desde el primer mes."',
      'testimonials.6.name': 'Jorge Beltran',
      'testimonials.6.role': 'Director de operaciones · B2B',
    ...
    en: {
      ...
      'hero.subtitle': 'We help <strong>SMEs and self-employed professionals</strong> order priorities, make better decisions and turn strategy into concrete action.',
      ...
      'que.card4.title': 'Analytics and decisions',
      'que.card4.lead': 'We turn scattered data into clear signals so you can decide faster with less risk.',
      'que.card4.focus': 'We work on: dashboard, key metrics and practical result reading.',
      'que.card5.title': 'Executive support',
      'que.card5.lead': 'We align team, priorities and execution rhythm so strategy actually moves forward.',
      'que.card5.focus': 'We work on: follow-up, weekly focus and decision unblock.',
      ...
      'testimonials.subtitle': 'Real outcomes across different sectors and business contexts.',
      'testimonials.outro': 'Real stories, clear decisions and growth with focus.',
      'testimonials.1.quote': '"In three months we moved from improvised campaigns to a clear commercial plan. The team now works with priorities and sales improved steadily."',
      'testimonials.1.name': 'Laura Mendez',
      'testimonials.1.role': 'Commercial Director · Retail',
      'testimonials.1.lang': 'English',
      'testimonials.2.quote': '"We moved from scattered ideas to structured execution. Every action now has an owner, deadline and measurable target."',
      'testimonials.2.name': 'Andrew Ross',
      'testimonials.2.role': 'Founder · Food business',
      'testimonials.2.lang': 'English',
      'testimonials.3.quote': '"Polaris sharpened our brand message and acquisition strategy. In two quarters, qualified leads increased without inflating budget."',
      'testimonials.3.name': 'Claudia Perez',
      'testimonials.3.role': 'Marketing Lead · Textile',
      'testimonials.3.lang': 'English',
      'testimonials.4.quote': '"They helped us simplify digital operations and make faster decisions with clear data. The team now works with less friction."',
      'testimonials.4.name': 'Nathan Green',
      'testimonials.4.role': 'CEO · Home decor',
      'testimonials.4.lang': 'English',
      'testimonials.5.quote': '"The 90-day roadmap was critical to regain focus. We stopped reacting and started building sustainable growth."',
      'testimonials.5.name': 'Sofia Vega',
      'testimonials.5.role': 'General Manager · Hospitality',
      'testimonials.5.lang': 'English',
      'testimonials.6.quote': '"Implementation quality was the difference: useful meetings, concrete decisions and real follow-up. We saw impact from month one."',
      'testimonials.6.name': 'James Brown',
      'testimonials.6.role': 'Operations Director · B2B',
    ...
    pt: {
      ...
      'hero.subtitle': 'Ajudamos <strong>PMEs e profissionais autonomos</strong> a ordenar prioridades, tomar melhores decisoes e transformar estrategia em acoes concretas.',
      ...
      'que.card4.title': 'Analitica e decisoes',
      'que.card4.lead': 'Transformamos dados dispersos em sinais claros para decidir mais rapido e com menos risco.',
      'que.card4.focus': 'Trabalhamos em: dashboard, metricas-chave e leitura pratica de resultados.',
      'que.card5.title': 'Acompanhamento executivo',
      'que.card5.lead': 'Alinhamos equipa, prioridades e ritmo de execucao para que a estrategia avance de verdade.',
      'que.card5.focus': 'Trabalhamos em: seguimento, foco semanal e desbloqueio de decisoes.',
      ...
      'testimonials.subtitle': 'Resultados reais em diferentes setores e contextos de negocio.',
      'testimonials.outro': 'Historias reais, decisoes claras e crescimento com foco.',
      'testimonials.1.quote': '"Em tres meses passamos de campanhas improvisadas para um plano comercial claro. A equipa ganhou foco e as vendas cresceram de forma consistente."',
      'testimonials.1.name': 'Laura Mendes',
      'testimonials.1.role': 'Diretora comercial · Retalho',
      'testimonials.1.lang': 'Português',
      'testimonials.2.quote': '"Saímos de ideias soltas para execucao estruturada. Hoje cada acao tem responsavel, prazo e objetivo mensuravel."',
      'testimonials.2.name': 'Andre Rocha',
      'testimonials.2.role': 'Socio fundador · Alimentacao',
      'testimonials.2.lang': 'Português',
      'testimonials.3.quote': '"Com a Polaris melhoramos a mensagem da marca e a captacao. Em dois trimestres aumentamos leads qualificados sem subir o investimento."',
      'testimonials.3.name': 'Carla Pinto',
      'testimonials.3.role': 'Lider de marketing · Textil',
      'testimonials.3.lang': 'Português',
      'testimonials.4.quote': '"Ajudaram-nos a simplificar a operacao digital e a decidir mais rapido com dados claros. A equipa trabalha com menos friccao."',
      'testimonials.4.name': 'Nuno Gomes',
      'testimonials.4.role': 'CEO · Decoracao',
      'testimonials.4.lang': 'Português',
      'testimonials.5.quote': '"O roadmap de 90 dias foi decisivo para recuperar foco. Deixamos de reagir e passamos a construir crescimento sustentado."',
      'testimonials.5.name': 'Sofia Vieira',
      'testimonials.5.role': 'Direcao geral · Restauracao',
      'testimonials.5.lang': 'Português',
      'testimonials.6.quote': '"A diferenca esteve na implementacao: reunioes uteis, decisoes concretas e acompanhamento real. Vimos impacto desde o primeiro mes."',
      'testimonials.6.name': 'Joao Barbosa',
      'testimonials.6.role': 'Diretor de operacoes · B2B',
    ...
    fr: {
      ...
      'hero.subtitle': 'Nous aidons les <strong>PME et independants</strong> a organiser leurs priorites, prendre de meilleures decisions et transformer la strategie en actions concretes.',
      ...
      'que.card4.title': 'Analyse et decisions',
      'que.card4.lead': 'Nous transformons des donnees dispersees en signaux clairs pour decider plus vite et avec moins de risque.',
      'que.card4.focus': 'Nous travaillons sur : tableau de bord, indicateurs cles et lecture pratique des resultats.',
      'que.card5.title': 'Accompagnement executif',
      'que.card5.lead': "Nous alignons equipe, priorites et rythme d'execution pour que la strategie avance vraiment.",
      'que.card5.focus': 'Nous travaillons sur : suivi, focus hebdomadaire et deblocage des decisions.',
      ...
      'testimonials.eyebrow': 'Temoignages',
      'testimonials.title': 'Ce que disent nos clients',
      'testimonials.subtitle': 'Des resultats concrets dans differents secteurs et contextes.',
      'testimonials.outro': 'Des histoires reelles, des decisions claires et une croissance maitrisee.',
      'testimonials.1.quote': '"En trois mois, nous sommes passes de campagnes improvisees a un plan commercial clair. L equipe a gagne en priorites et les ventes ont progresse."',
      'testimonials.1.name': 'Laura Mendez',
      'testimonials.1.role': 'Directrice commerciale · Retail',
      'testimonials.1.lang': 'Français',
      'testimonials.2.quote': '"Nous sommes passes d idees dispersees a une execution structuree. Chaque action a maintenant un responsable, une date et un objectif."',
      'testimonials.2.name': 'Antoine Roussel',
      'testimonials.2.role': 'Fondateur · Alimentaire',
      'testimonials.2.lang': 'Français',
      'testimonials.3.quote': '"Polaris a clarifie notre message de marque et notre acquisition. En deux trimestres, les leads qualifies ont augmente sans gonfler le budget."',
      'testimonials.3.name': 'Claire Perrot',
      'testimonials.3.role': 'Responsable marketing · Textile',
      'testimonials.3.lang': 'Français',
      'testimonials.4.quote': '"L accompagnement a simplifie l operation digitale et accelere les decisions grace a des indicateurs clairs. L equipe est plus fluide."',
      'testimonials.4.name': 'Nicolas Garnier',
      'testimonials.4.role': 'CEO · Decoration',
      'testimonials.4.lang': 'Français',
      'testimonials.5.quote': '"La feuille de route a 90 jours nous a redonne du cap. Nous avons arrete de reagir pour construire une croissance durable."',
      'testimonials.5.name': 'Sophie Vasseur',
      'testimonials.5.role': 'Direction generale · Restauration',
      'testimonials.5.lang': 'Français',
      'testimonials.6.quote': '"La vraie valeur a ete l execution: reunions utiles, decisions concretes et suivi reel. Les premiers effets sont arrives rapidement."',
      'testimonials.6.name': 'Julien Bernard',
      'testimonials.6.role': 'Directeur des operations · B2B',
